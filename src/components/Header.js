...
export default function Header() {
  const [isLoginCliced, setisLoginCliced] = useState(false);
  return (
    <div>
      <div className="flex flex-row sticky">
        <div className="basis-1/4 my-1.5">
          ...
          <Link to="/">
            <span className="absolute top-3 text-2xl cursor-pointer">
              Meraahi India
            </span>
          </Link>
        </div>
        ...
        <div className="shrink pr-5 pt-5 text-xl w-60">
          ...
          <div>
            ...
            <span
              ...
              onClick={() => setisLoginCliced(true)}
            >
              Sign in
            </span>
            <Modal
              comp={<Login />}
              loginClicked={isLoginCliced}
              onCloseClick={() => setisLoginCliced(false)}
            ></Modal>
          </div>
        </div>
      </div>
